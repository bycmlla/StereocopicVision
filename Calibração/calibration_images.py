...
imagesLeft = glob.glob('EpipolarGeometryAndStereoVision/EpipolarGeometryAndStereoVision\camera1/*.jpg')
# print(imagesLeft)
imagesRight = glob.glob('EpipolarGeometryAndStereoVision/EpipolarGeometryAndStereoVision/camera0/*jpg')
